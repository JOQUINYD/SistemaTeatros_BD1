...
namespace SistemaTeatroWebApp.Models
{
    ...
    public partial class SistemaTeatros_BD1Entities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> spGetAsientosVaciosFila(Nullable<int> idPresentacion, Nullable<int> idBloque, string letra)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("spGetAsientosVaciosFila", idPresentacionParameter, idBloqueParameter, letraParameter);
        }
        ...
        public virtual ObjectResult<spGetInfoBloqueById_Result> spGetInfoBloqueById(Nullable<int> idBloque)
        {
            var idBloqueParameter = idBloque.HasValue ?
                new ObjectParameter("IdBloque", idBloque) :
                new ObjectParameter("IdBloque", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetInfoBloqueById_Result>("spGetInfoBloqueById", idBloqueParameter);
        }
        ...
        public virtual ObjectResult<spGetBloquesByTeatroConPrecio_Result> spGetBloquesByTeatroConPrecio(Nullable<int> idTeatro, Nullable<int> idPresentacion)
        {
            var idTeatroParameter = idTeatro.HasValue ?
                new ObjectParameter("IdTeatro", idTeatro) :
                new ObjectParameter("IdTeatro", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetBloquesByTeatroConPrecio_Result>("spGetBloquesByTeatroConPrecio", idTeatroParameter, idPresentacionParameter);
        }
    
        public virtual ObjectResult<spGetProduccionesEstadoById_Result> spGetProduccionesEstadoById(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetProduccionesEstadoById_Result>("spGetProduccionesEstadoById", idParameter);
        }
    
        public virtual ObjectResult<spGetProduccionesEstados_Result> spGetProduccionesEstados()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetProduccionesEstados_Result>("spGetProduccionesEstados");
        }
    }
}
